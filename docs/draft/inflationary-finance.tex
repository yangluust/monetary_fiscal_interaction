...
m_t \ge \theta P_t z_t.
\]
Let $s_t$ denote the real fee per unit of payment services paid by non-banks to banks. To determine the fee, consider the non-bank payment-services subproblem. Taking $s_t$ as given, non-banks choose $C^N_t$ and $Z_t$ to solve
\[
