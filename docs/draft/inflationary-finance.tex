...
\]
which is negative whenever the non-bank marginal rate of substitution $\mathcal{U}_z/\mathcal{U}_C$ is decreasing in payment services. Thus the normalized shadow value of reserves declines with reserve holdings along the non-bank inverse demand curve. The reduced-form specification is obtained by defining
\[
